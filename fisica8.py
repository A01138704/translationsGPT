...
def translate_text_chunks_and_save(chunks, output_file_path):
    ...
    for index, chunk in enumerate(chunks):
        ...
        try:
            ...
            print(completion.choices[0])  # Debug: Print the 'Choice' object to understand its structure
            
            # Assuming the correct property based on typical API responses
            translated_chunk = completion.choices[0].text.strip()  # This might need to be adjusted
