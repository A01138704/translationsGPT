...
def translate_text_chunks_and_save(chunks, output_file_path):
    ...
    for index, chunk in enumerate(chunks):
        ...
        try:
            ...
            print(completion)  # Debug: Print the entire completion object
            translated_chunk = completion.choices[0].message['content'].strip()  # Adjusted for correct path based on printed structure
