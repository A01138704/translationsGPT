...
def translate_text_chunks_and_save(chunks, output_file_path):
    ...
    for index, chunk in enumerate(chunks):
        ...
        try:
            ...
            print(completion)  # Debug: Print the entire completion object to see its structure

            # If the following line errors, replace it based on the printed completion structure:
